...
Usage:
    ...
    python3 -m test_pyramid_app.scripts.init_db --help
...
def delete(engine: Engine) -> None:
    ...
    try:
        from test_pyramid_app.db import pre_delete
    except ImportError:
        pass
    else:
        pre_delete(engine)
    ...
    try:
        from test_pyramid_app.db import post_delete
    except ImportError:
        pass
    else:
        post_delete(engine)
...
def create(engine: Engine) -> None:
    ...
    try:
        from test_pyramid_app.db import pre_create
    except ImportError:
        pass
    else:
        pre_create(engine)
    ...
    try:
        from test_pyramid_app.db import post_create
    except ImportError:
        pass
    else:
        post_create(engine)
